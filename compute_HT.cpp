...
int main(int argc, char *argv[])
{
	...
	if(algo_id == 1)
	{
		hyper_candidates.push_back(frontierMax(t.size(), t, time_multiplier));
		...
		for(int i = 10 ; i <= 50 ; i += 5)
        	{
	                hyper_candidates.push_back(frontierMaxPT(t.size(), t, time_multiplier, i));
			...
			hyper_candidates.push_back(frontierMaxPT_UP(t.size(), t, time_multiplier, i));
        ...
        {
                hyper_candidates.push_back(frontierMin(t.size(), t, time_multiplier));
                ...
                for(int i = 10 ; i <= 50 ; i += 5)
                {
                        hyper_candidates.push_back(frontierMinPT(t.size(), t, time_multiplier, i));
                        ...
                        hyper_candidates.push_back(frontierMinPT_UP(t.size(), t, time_multiplier, i));
	...
	{
                hyper_candidates.push_back(trLenWtdMin(t.size(), t, time_multiplier));
                ...
                for(int i = 10 ; i <= 50 ; i += 5)
                {
                        hyper_candidates.push_back(trLenWtdMinPT(t.size(), t, time_multiplier, i));
                        ...
                        hyper_candidates.push_back(trLenWtdMinPT_UP(t.size(), t, time_multiplier, i));
	...
	{
		hyper_candidates.push_back(trByteWtMin(t.size(), t, time_multiplier));
                ...
                for(int i = 10 ; i <= 50 ; i += 5)
                {
                        hyper_candidates.push_back(trByteWtMinPT(t.size(), t, time_multiplier, i));
	...
	{
                hyper_candidates.push_back(trLenWtdMax(t.size(), t, time_multiplier));
                ...
                for(int i = 10 ; i <= 50 ; i += 5)
                {
                        hyper_candidates.push_back(trLenWtdMaxPT(t.size(), t, time_multiplier, i));
                        ...
                        hyper_candidates.push_back(trLenWtdMaxPT_UP(t.size(), t, time_multiplier, i));
	...
	{
		hyper_candidates.push_back(trByteWtMax(t.size(), t, time_multiplier));
                ...
                for(int i = 10 ; i <= 50 ; i += 5)
                {
                        hyper_candidates.push_back(trByteWtMaxPT(t.size(), t, time_multiplier, i));
